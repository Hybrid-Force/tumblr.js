 ...
 * @param {Object|Array.<Object>} credentials
 * @returns {Object}
 */
function pickCredential(credentials) {
...
TumblrClient.prototype.getRequest = function(apiPath, params, callback) {
    ...
    return getRequest(this.request.get, pickCredential(this.credentials), this.baseUrl, apiPath, this.requestOptions, params, callback);
};
...
TumblrClient.prototype.postRequest = function(apiPath, params, callback) {
    ...
    return postRequest(this.request.post, pickCredential(this.credentials), this.baseUrl, apiPath, this.requestOptions, params, callback);
};
